...
const DB_NAME = "radQuizAppV4-ipadclean-20260512";
const DB_VERSION = 1;
...
function setRuntimeBanner() {
  ...
  if (!banner) return;
  if (FILE_PROTOCOL) {
    banner.innerHTML = "<strong>直接ファイルを開いています。</strong> 学習自体は使えますが、PWAのインストールやService Worker更新はローカルサーバー経由で有効になります。";
    banner.classList.remove("hidden");
  } else if (IOS_DEVICE && !STANDALONE_MODE) {
